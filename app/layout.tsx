  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 8, item: { '@type': 'CreativeWork', name: 'Scripting Engine', description: 'Closed-loop creative operations product for generating scripts, reviewing versions, publishing content, measuring performance, and improving future prompts through brand memory and campaign results.', url: 'https://scripting-engine.vercel.app/' } },
        { '@type': 'ListItem', position: 9, item: { '@type': 'CreativeWork', name: 'LeadCraft IT Solutions', description: 'Full 5-page WordPress/Elementor website for a US+Bangladesh ITES/BPO company, featuring WebGL shaders, GSAP animations, Lenis smooth scroll, Globe.gl visualization, and Swiper carousel.', url: 'https://www.leadcraftit.com/' } },
      ],
    },
  ],
};
